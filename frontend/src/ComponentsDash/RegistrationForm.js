      ...
      <div class="px-6 py-8">
        <div class="max-w-4xl mx-auto">
          <div class="bg-white rounded-3xl p-8 mb-5">
            <form class="font-[sans-serif] m-6 max-w-4xl mx-auto mt-20">
              <div class="grid sm:grid-cols-2 gap-10">
                <div class="relative flex items-center">
                  <label class="text-[13px] bg-yellow-50  text-black absolute px-2 top-[-10px] left-[18px] font-semibold">
                    First Name
                  </label>
                  <input
                    type="text"
              ...
              <button
                type="button"
                class="mt-8 px-6 py-2.5 w-full text-sm font-semibold bg-blue-500 text-white rounded hover:bg-blue-600"
              >
                Submit
              </button>
            </form>
